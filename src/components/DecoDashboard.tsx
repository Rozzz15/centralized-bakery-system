...
import type { ProductionTask, DOSItem, MaterialRequest, ProductRecipe, InventoryItem } from "../types";
...
export default function DecoDashboard({ production, dosItems, onCompleteTask, activeTab, setActiveTab, productCatalog, recipes, inventory, onUpdateInventory, onUpdateRecipes, onAddAuditLog }: Props) {
                  ...
                  return (
                    <Fragment key={d.id}>
                      <tr className="border-b border-zinc-50 text-[13px] hover:bg-zinc-50/50 transition-colors">
                        ...
                        <td className="px-2 py-2.5 font-medium text-zinc-900">{d.product}</td>
